...
@SpringBootTest(classes = {UserService.class, PropertiesConfig.class,
...
public class UserServiceTest {
    ...
    void testGetUsersByRole() {
        when(soteriaUserService.getUsersByRole(any(CerberusUserInformation.class), eq("reviewer")))
        ...
        List<User> users = userService.getUsersByRole(new UserContext(new CerberusUserInformation(), Collections.emptySet()), "reviewer");
        ...
        verify(soteriaUserService).getUsersByRole(any(CerberusUserInformation.class), eq("reviewer"));
    }
    ...
    void testGetAllUsersByRole() {
        ...
        List<User> users = userService.getAllUsersByRole(new UserContext(new CerberusUserInformation(), Collections.emptySet()), "reviewer");
        ...
        assertThat(user2.getId()).isEqualTo("user1");
        assertThat(user2.getFirstName()).isEqualTo("First1");
        assertThat(user2.getLastName()).isEqualTo("McLast1");
        assertThat(user2.getFullName()).isEqualTo("First1 McLast1");
        assertThat(user2.getRoles()).containsExactlyInAnyOrder("reviewer");
