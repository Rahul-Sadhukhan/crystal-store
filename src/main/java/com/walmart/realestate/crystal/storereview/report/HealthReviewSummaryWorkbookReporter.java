...
@Slf4j
public class HealthReviewSummaryWorkbookReporter implements WorkbookReporter {
    ...
    @Getter
    private final String reportName = " - DOC Refrigeration Health Review: Summary Report";

    public HealthReviewSummaryWorkbookReporter(MetadataProperties metadataProperties, StoreReviewReport storeReviewReport, WorkbookUtil workbookUtil) {
    ...
    public String getTemplatePath() {
        return "report/templates/store-review-report/Crystal-HR-Template.xlsx";
    }
